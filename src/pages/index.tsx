...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`planning tourist places`}</title>

        <meta
          name="description"
          content="Planning Tourist Places - Your key to unlocking Peru's wonders. Seamlessly plan your travels, integrate with Google Maps, and secure your data with Google and username-password login."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1526392060635-9d6019884377?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxQZXJ1fGVufDB8fHx8MTY5Njk4MDcxOXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@willianjusten?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Willian Justen de Vasconcellos`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`planning tourist places`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Planning Tourist Places - Your key to unlocking Peru's wonders. Seamlessly plan your travels, integrate with Google Maps, and secure your data with Google and username-password login.`}
            </Text>
            <Box
