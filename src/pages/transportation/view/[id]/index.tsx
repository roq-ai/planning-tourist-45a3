...
import { getTransportationById } from 'apiSdk/transportation';
import { TransportationInterface } from 'interfaces/transportation';

function TransportationViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('transportation', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/transportation/edit/${id}`} passHref legacyBehavior>
                    <Button
